...
export bscale_dtype="bf16";  /softhome/like/opt/cuda-12.8/bin/ncu  --metrics l1tex__t_sectors_pipe_lsu_mem_global_op_ld.sum,l1tex__t_requests_pipe_lsu_mem_global_op_ld.sum \
