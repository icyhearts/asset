...
do
  ...
  #                               |英文标点     |多个空格           |[1,inf)个英文左圆括号|[1,inf)个英文右圆括号|[1,inf)个_接[1,inf)个.     |[1,inf)个[         |[1,inf)个]            |
...
#   NEWFILENAME=$(echo $NEWFILENAME1|sed 's/[】【？]\{1,\}/_/g' | sed 's/（\{1,\}/_/g'| sed 's/）\{1,\}/_/g'|sed 's/,\{1,\}/_/g'|sed 's/^_\{1,\}//g'|sed 's/_\{1,\}/_/g')
  # 合并所有中文的标点符号
  NEWFILENAME=$(echo $NEWFILENAME1|sed 's/[-、，～（）：】【！？“”]\{1,\}/_/g'|sed 's/[,:]\{1,\}/_/g'|sed 's/^_\{1,\}//g'|sed 's/_\{1,\}$//g'| sed 's/_\{1,\}/_/g')
