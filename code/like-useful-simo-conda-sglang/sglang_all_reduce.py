#!/usr/bin/env python3
"""Run SGLang tensor-parallel all-reduce on saved RowParallelLinear outputs.

Usage:
  /data/like/miniconda3/envs/simo_sglang/bin/torchrun --nproc_per_node=8 \
    like-useful/sglang_all_reduce.py
"""
...
SGLANG_REPO = "/data/like/package/sglang_kernel_src"
INPUT_TEMPLATE = (
...
OUTPUT_PATH = "/data/like/temp/sglang.safetensors"
OUTPUT_KEY = "rank_0_all_reduce"


def _add_repo_to_path() -> None:
    for path in (
        f"{SGLANG_REPO}/python",
        f"{SGLANG_REPO}/sgl-kernel/python",
    ):
