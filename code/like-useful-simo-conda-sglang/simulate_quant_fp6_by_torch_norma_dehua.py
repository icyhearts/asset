...
# 4) 平局, mant_odd=1
x_pos = torch.tensor([0x40580000],dtype=torch.int32).view(torch.float32)
# 5) 不平局, 大于0.5, mant_odd=1
x_pos = torch.tensor([0x40590000],dtype=torch.int32).view(torch.float32)
