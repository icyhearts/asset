...
from simo.extensions.sglang_simo.quantization.quantization import parse_quantize_spec, get_downcast_kernel
import torch
import json
from safetensors.torch import load_file
if True:
    if True:
      # time_prefix = "1776138112.5518694"
      # time_prefix = "1776155377.4769642"
      # time_prefix = "1776176911.544467"#mxint8
      # time_prefix = "1776246785.8633173"#fp8 per group
      # time_prefix = "1776246917.2021449" # 不知道是什么格式的
      time_prefix = "1780562850.023262" # mla mxfp8
      ...
      layer.kv_cache_downcast_kernel = get_downcast_kernel(layer.kv_cache_quant_spec)
      for rope_attr in ["packed_head_size_rope","scale_head_size_rope"]:
        if layer_dict.get(rope_attr, None):
          setattr(layer, rope_attr, layer_dict.get(rope_attr))
