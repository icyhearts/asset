...
badd +5 n3_transformer.py
badd +741 ~/miniconda3/envs/vllm_new/lib/python3.10/site-packages/transformers/cache_utils.py
badd +2423 ~/miniconda3/envs/vllm_new/lib/python3.10/site-packages/transformers/generation/utils.py
badd +349 ~/miniconda3/envs/vllm_new/lib/python3.10/site-packages/transformers/generation/configuration_utils.py
badd +0 ~/opt/nginx_install/html/llmNotes/images/callGraph.dot
badd +0 transformers/models/llama/modeling_llama.py
badd +7 ~/opt/nginx_install/html/llmNotes/images/class.pu
...
badd +0 ~/miniconda3/envs/vllm_new/lib/python3.10/site-packages/transformers/generation/logits_process.py
argglobal
%argdel
...
exe 'vert 3resize ' . ((&columns * 156 + 136) / 272)
argglobal
enew
file NERD_tree_1
...
silent! normal! zE
let &fdl = &fdl
let s:l = 121 - ((67 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 121
...
silent! normal! zE
let &fdl = &fdl
let s:l = 413 - ((36 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 413
...
silent! normal! zE
let &fdl = &fdl
let s:l = 545 - ((1 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 545
...
silent! normal! zE
let &fdl = &fdl
let s:l = 563 - ((34 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 563
...
exe 'vert 2resize ' . ((&columns * 156 + 136) / 272)
tabnext
edit transformers/models/llama/modeling_llama.py
let s:save_splitbelow = &splitbelow
let s:save_splitright = &splitright
set splitbelow splitright
wincmd _ | wincmd |
...
silent! normal! zE
let &fdl = &fdl
let s:l = 382 - ((37 * winheight(0) + 37) / 75)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 382
